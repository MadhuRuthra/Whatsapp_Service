            ...
            <div class="row">
                  ...
                  <form class="md-float-material form-material" action="#" name="frm_edit_onboarding" id='frm_edit_onboarding' class="needs-validation" novalidate="" enctype="multipart/form-data" method="post">
                    <div>
                      ...
                      <div class="row mt-2">
                        ...
                        <div class="col-4">
                          <input type="text" name="bill_address" id="bill_address" class="form-control" value="<?=$billing_address?>" maxlength="300" tabindex="6" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Billing Address & GST" placeholder="Billing Address & GST" pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                        </div>
                      </div>
                      ...
                      <div class="row mt-2">
                        ...
                        <div class="col-4">
                          <input type="text" name="cpy_website_details" id="cpy_website_details" class="form-control" maxlength="100" value="<?=$company_website?>" tabindex="8" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Company website details" placeholder="Company website details" pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                        </div>
                      </div>
                      <div class="row mt-2">
                        <div class="col-2 label">
                      ...
                      <div class="row mt-2">
                        ...
                        <div class="col-4">
                          <input type="text" name="desp_business_txt" id="desp_business_txt" class="form-control" value="<?=$description_business?>" maxlength="200" tabindex="11" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Description of the business" placeholder="Description of the business" pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                        </div>
                        <div class="col-2 label">
                          Registered Address of the business<label style="color:#FF0000">*</label>
                        </div>
                        <div class="col-4">
                          <input type="text" name="reg_add_business" id="reg_add_business" class="form-control" value="<?=$user_address?>" maxlength="100" tabindex="12" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Official addres" placeholder=" Registered Address of the business" pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                        </div>
                      </div>
			  ...
			  <? if($profile_image != '') { ?><img src="uploads/whatsapp_images/<?=$profile_image?>" style="width: 100px; height: 100px;"><? } ?>
                      ...
                      <div class="row mt-2">
                        ...
                        <div class="col-4">
                          <input type="text" name="sender_id_txt" id="sender_id_txt" class="form-control" value="<?=$sender?>" maxlength="50" tabindex="17" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Recommend fresh no or never used whats app" placeholder="Sender ID">
                        </div>
                        <div class="col-2 label">
                          Sender ID- 1 (Communication)<label style="color:#FF0000">*</label>
                        </div>
                        <div class="col-4">
                          <textarea type="text" name="sender_id_txt_1_txt" id="sender_id_txt_1_txt" class="form-control" maxlength="300" tabindex="18" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters." placeholder="Sender ID- 1 "><?=$sender_1?></textarea>
                        </div>
                      </div>
                      <div class="row mt-2">
                        <div class="col-2 label">
                        ...
                        <div class="col-4">
                          <textarea type="text" name="sender_id_txt_2_txt" id="sender_id_txt_2_txt" class="form-control" maxlength="300" tabindex="19" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters." placeholder="Sender ID 2"><?=$sender_2?></textarea>
                        </div>
                        <div class="col-2 label">
                      ...
                      <div class="row mt-2">
                        ...
                        <div class="col-4">
                          <input type="text" name="enquiry_approve_txt" id="enquiry_approve_txt" class="form-control" value="<?=$enquiry_approval?>" maxlength="100" tabindex="22" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Enquiry/ Approval page" placeholder="Enquiry/ Approval page" pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                        </div>
                      </div>
                      <div class="row mt-2">
                        <div class="col-2 label">
                        ...
                        <div class="col-4">
                          <input type="text" name="privacy_terms_txt" id="privacy_terms_txt" class="form-control" value="<?=$privacy_terms?>" maxlength="100" tabindex="23" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Privacy & terms of service page" placeholder="Privacy & terms of service page" pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                        </div>
                        <div class="col-2 label">
                          Terms & Condition page<label style="color:#FF0000">*</label>
                        </div>
                        <div class="col-4">
                          <input type="text" name="terms_condition_txt" id="terms_condition_txt" class="form-control" value="<?=$terms_conditions?>" maxlength="100" tabindex="24" required="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Official T&C page" placeholder="Terms & Condition page" pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                        </div>
                      </div>
                      <div class="row mt-2">
                        <div class="col-2 label">
...
<!-- include site footer -->
  ...
  <script>
    ...
    // $("#submit_onboarding").click(function(e) {
    $(document).on("submit", "form#frm_edit_onboarding", function (e) {
      ...
      if (flag) {
        // var data_serialize = $("#frm_edit_onboarding").serialize();
