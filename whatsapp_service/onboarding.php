...
site_log_generate("Onboarding Page : Unknown User : '" . $_SESSION['yjwatsp_user_id'] . "' access this page on " . date("Y-m-d H:i:s"));
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <style>
    ...
    .nav-tabs .nav-item .nav-link.active {
      color: #FFF; background-color: #568381;
    }
    .btn:not(:disabled):not(.disabled) { line-height: 25px !important; }
...
<body style="background:url(assets/img/bg_home.jpg); background-repeat:no-repeat; background-size:cover;">
        ...
        <div class="row" style="margin-right: 15px;">
          ...
          <div class="col-12" id="tab_signup" style="display:block;">
            ...
            <div class="row m-b-20">
              ...
              <div class="col-md-12">
                <h3 class="text-center"><i class="icofont icofont-sign-in"></i>Onboarding Form</h3>
              </div>
            </div>
            ...
            <div class="card-outline-tabs">
              ...
              <div class="card-body" style="border-bottom: 1px solid #dee2e6; margin-top: -12px; border-left: 1px solid #dee2e6; border-right: 1px solid #dee2e6;">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="contact_person_txt" id="contact_person_txt" class="form-control"
                          value="" maxlength="50" tabindex="2" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title=" Contact person"
                          placeholder="Contact person" pattern="[a-zA-Z0-9 -_]+"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="designation_txt" id="designation_txt" class="form-control" value=""
                          maxlength="100" tabindex="3" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Contact person designation"
                          placeholder="Contact person designation" pattern="[a-zA-Z0-9 -_]+"
                          onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                      </div>
                    </div>
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="mobile_no_txt" id="mobile_no_txt" class="form-control" value=""
                          ...
                          data-placement="top" title="" data-original-title="Contact person Contact no"
                          placeholder="Contact person Contact no" onblur=""
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="email_id_contact" id="email_id_contact" class="form-control" 
                          maxlength="100" tabindex="5" autofocus="" required="" data-toggle="tooltip" value=""
                          data-placement="top" title="" data-original-title="Contact person Email ID" onblur= ""
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="bill_address" id="bill_address" class="form-control" value=""
                          maxlength="100" tabindex="6" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Billing Address & GST"
                          placeholder="Billing Address & GST" pattern="[a-zA-Z0-9 -_]+">
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                     <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="business_name" id="business_name" class="form-control" value=""
                          maxlength="100" tabindex="7" autofocus="" required="" data-toggle="tooltip"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <textarea type="text" name="cpy_website_details" id="cpy_website_details" class="form-control"
                          value="" maxlength="256" tabindex="8" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Company website details"
                          placeholder="Company website details" pattern="[a-zA-Z0-9 -_]+"></textarea>
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                      ...
                      <div class="col-6">
                        <input type="text" name="parent_company_name" id="parent_company_name" class="form-control"
                          value="" maxlength="100" tabindex="9" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Parents company name"
                          placeholder="Parents company name" pattern="[a-zA-Z0-9 -_]+"
                          onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
                      </div>
                    </div>
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <textarea type="text" name="cpy_display_name" id="cpy_display_name" class="form-control"
                          value="" maxlength="255" tabindex="10" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Group company name"
                          placeholder="Company display name" pattern="[a-zA-Z0-9 -_]+"
                          onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;"></textarea>
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                      ...
                      <div class="col-6">
                        <textarea type="text" name="desp_business_txt" id="desp_business_txt" class="form-control"
                          value="" maxlength="512" tabindex="11" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Description of the business"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <textarea type="text" name="reg_add_business" id="reg_add_business" class="form-control"
                          value="" maxlength="256" tabindex="12" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Official addres"
                          placeholder=" Registered Address of the business" pattern="[a-zA-Z0-9 -_]+"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="custom-tabs-four-settings" role="tabpanel" aria-labelledby="custom-tabs-four-settings-tab">
                     <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="email_id_txt" id="email_id_txt" class="form-control" value=""
                          ...
                          data-placement="top" title="" data-original-title=" Official Email ID"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="contact_no_cmpy" id="contact_no_cmpy" class="form-control" value=""
                          ...
                          data-placement="top" title="" data-original-title="Business contact no"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="file" name="profile_display_pic" id="profile_display_pic" class="form-control"
                          value="" maxlength="100" tabindex="15" autofocus="" required="" data-toggle="tooltip"
                    ...
                    <div class="row mt-2">
                      <div class="col-6 label">
                        Sender ID 1<label style="color:#FF0000">*</label>
                      </div>
                      <div class="col-6">
                        <input type="text" name="sender_id_txt" id="sender_id_txt" class="form-control" value=""
                          maxlength="100" tabindex="17" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Recommend fresh no or never used whatsapp"
                          placeholder="Sender ID 1">
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                        Communication<label style="color:#FF0000">*</label>
                      </div>
                      <div class="col-6">
                        <textarea type="text" name="sender_id_txt_1_txt" id="sender_id_txt_1_txt" class="form-control"
                          value="" maxlength="1024" tabindex="18" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title=""
                          data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters."
                          placeholder="Sender ID - 1 Communication"></textarea>
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                      ...
                      <div class="col-6">
                        <input type="text" name="sender_id2_txt" id="sender_id2_txt" class="form-control" value=""
                          maxlength="100" tabindex="19" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Recommend fresh no or never used whatsapp"
                          placeholder="Sender ID 2">
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                      ...
                      <div class="col-6">
                        <textarea type="text" name="sender_id_txt_2_txt" id="sender_id_txt_2_txt" class="form-control"
                          value="" maxlength="1024" tabindex="19" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title=""
                          data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters."
                          placeholder="Sender ID - 2 Communication"></textarea>
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                      ...
                      <div class="col-6">
                        <select class="form-select form-control" required="" aria-label="Default select example"
                          tabindex="20" id="type_of_message" name="type_of_message">
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <select class="form-select form-control" required="" aria-label="Default select example"
                          tabindex="21" id="otp_in_process" name="otp_in_process">
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="enquiry_approve_txt" id="enquiry_approve_txt" class="form-control"
                          value="" maxlength="100" tabindex="22" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Enquiry/ Approval page"
                          placeholder="Enquiry/ Approval page">
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                      ...
                      <div class="col-6">
                        <input type="text" name="privacy_terms_txt" id="privacy_terms_txt" class="form-control" value=""
                          maxlength="100" tabindex="23" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Privacy & terms of service page"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="terms_condition_txt" id="terms_condition_txt" class="form-control"
                          value="" maxlength="100" tabindex="24" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Official T&C page"
                          placeholder="Terms & Condition page">
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-6 label">
                      ...
                      <div class="col-6">
                        <select class="form-select form-control" required="" aria-label="Default select example"
                          tabindex="25" id="proof_document_slt" name="proof_document_slt">
                          <option value="business_registration_license">Business registration or License document
                          </option>
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="file" name="proof_document" id="proof_document" class="form-control" value=""
                          ...
                          data-placement="top" title=""
                          data-original-title=" Proof of document - Allowed only PDF files" accept="application/pdf"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="expected_volumes_day" id="expected_volumes_day" class="form-control"
                          value="" maxlength="100" tabindex="27" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Expected volumes for day"
                          placeholder="50000 per day"
                    ...
                    <div class="row mt-2">
                      <div class="col-12">
                        ...
                        <span class="text-inverse" style="color:#FF0000 !important">I read and accept <a
                            ...
                            class="alert-ajax btn-outline-info">Terms &amp; Conditions.</a></span><br>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body tab_signup">
                  <div class="row">
                    <div class="col-md-12" style="text-align:left;">
                      <span class="text-inverse" style="color:#FF0000 !important; font-weight: bold;">* Fields are Mandatory</span>
                    </div>
  ...
  <script>
    ...
    $(document).on("submit", "form#frm_signup", function (e) {
      ...
      var sender_id2_txt = $('#sender_id2_txt').val();
      ...
      if (sender_id2_txt == "") {
        $('#sender_id2_txt').css('border-color', 'red');
        flag = false;
      }
      ...
      var contact_no_cmpy = document.getElementById('mobile_no_txt').value;
...
if (parts[1] !== '') {
    ...
    $("#mobile_no_txt").prop("readonly", true);
} if (parts[0] !== '') {
    // If the first element is not an empty string, it means there is an email address
    $('#email_id_contact').val(parts[0]);
    $("#email_id_contact").prop("readonly", true);
}
          }else{
            $("#id_error_display_onboarding").html(response.msg);
            setInterval(function() {
            ...
            $("#mobile_no_txt").prop("readonly", false);
            $("#email_id_contact").prop("readonly", false);
          }
        },
