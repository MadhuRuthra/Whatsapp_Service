             ...
             <div class="card-body" >
                <form class="md-float-material form-material" action="#" name="frm_login" id='frm_login'  method="post">
                  <div>
                    ...
                    <div class="row m-t-1">
                      <div class="col-md-6 text-left"><? /* <a class="nav-link" data-toggle="tab" href="#tab_signup" onclick="func_open_tab_signin()" role="tab"> New Users : Sign up</a> */ ?><a class="nav-link" href="onboarding"> New Users : Sign up</a></div>
...
onkeypress="return (event.charCode !=8 && event.charCode ==0 ||  (event.charCode >= 48 && event.charCode <= 57))" >
                    ...
                    <div class="row mt-2">
                      ...
                      <textarea type="text" name="cpy_website_details" id="cpy_website_details" class="form-control" value=""
                          maxlength="256" tabindex="8" autofocus="" required="" data-toggle="tooltip"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="parent_company_name" id="parent_company_name" class="form-control" value=""
                          maxlength="100" tabindex="9" autofocus="" required="" data-toggle="tooltip"
                    ...
                    <div class="row mt-2">
                      ...
                      <textarea type="text" name="cpy_display_name" id="cpy_display_name" class="form-control" value=""
                          maxlength="255" tabindex="10" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Group company name" placeholder="Company display name" 
                         pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;"
                          ></textarea>
                      </div>
                    </div>
                    <div class="row mt-2">
                     ...
                     Description of the business<label
                      ...
                      <textarea type="text" name="desp_business_txt" id="desp_business_txt" class="form-control" value=""
                          maxlength="512" tabindex="11" autofocus="" required="" data-toggle="tooltip"
                    ...
                    <div class="row mt-2">
                      ...
                      <textarea type="text" name="reg_add_business" id="reg_add_business" class="form-control" value=""
                          maxlength="256" tabindex="12" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Official addres" placeholder=" Registered Address of the business" 
                           pattern="[a-zA-Z0-9 -_]+" 
                          ></textarea>
                      </div>
                    </div>
  ...
  // Looping the indicator is less than the count of report.if the condition is true to continue the process and to get the report details.if the condition are false to stop the process and to send the no available data
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="sender_id_txt" id="sender_id_txt" class="form-control" value=""
                          maxlength="10"  onkeypress="return (event.charCode !=8 && event.charCode ==0 ||  (event.charCode >= 48 && event.charCode <= 57))" tabindex="17" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Recommend fresh no or never used whatsapp" placeholder="Sender ID" 
                            >
                      </div>
                      </div>    
                    ...
                    <div class="row mt-2">
                      ...
                      <textarea type="text" name="sender_id_txt_1_txt" id="sender_id_txt_1_txt" class="form-control" value=""
                          maxlength="1024" tabindex="18" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters." placeholder="Sender ID 1 " 
                          ></textarea>
                      </div>
                    </div>  
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="sender_id_2_txt" id="sender_id_2_txt" class="form-control" value=""
                          maxlength="10"  onkeypress="return (event.charCode !=8 && event.charCode ==0 ||  (event.charCode >= 48 && event.charCode <= 57))" tabindex="17" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Recommend fresh no or never used whatsapp" placeholder="Sender ID 2" 
                            >
                      </div></div>
                    ...
                    <div class="row mt-2">
                      ...
                      <textarea type="text" name="sender_id_txt_2_txt" id="sender_id_txt_2_txt" class="form-control" value=""
                          maxlength="1024" tabindex="19" autofocus="" required="" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters." placeholder="Sender ID 2" 
                            ></textarea>
                      </div>
                      </div>                 
                    <div class="row mt-2">
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="enquiry_approve_txt" id="enquiry_approve_txt" class="form-control" value=""
                          maxlength="100" tabindex="22" autofocus="" required="" data-toggle="tooltip"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="terms_condition_txt" id="terms_condition_txt" class="form-control" value=""
                          maxlength="100" tabindex="24" autofocus="" required="" data-toggle="tooltip"
                     ...
                     <div class="row mt-2">
                      ...
                      <div class="col-6">
                        <input type="text" name="expected_volumes_day" id="expected_volumes_day" class="form-control" value=""
                          maxlength="100" tabindex="27" autofocus="" required="" data-toggle="tooltip"
