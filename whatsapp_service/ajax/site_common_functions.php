<?
/*
Authendicated users details getting to navigate this site common function page.
This page is used to give the API request to send the mobile whatsapp message the API response. 
