...
if($_SERVER['REQUEST_METHOD'] == "POST" and $tmpl_call_function == "save_phbabt") {
  ...
  if($yjresponseobj->response_msg == 'Error occurred'){
    $json = array("status" => 2, "msg" => "Save option Failed!!. Must fill all fields!!" );
  }
    else{
