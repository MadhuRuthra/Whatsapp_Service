    ...
    <ul class="sidebar-menu">
      ...
      <? if ($_SESSION['yjwatsp_user_master_id'] == 1 or $_SESSION['yjwatsp_user_master_id'] == 2 or $_SESSION['yjwatsp_user_master_id'] == 3) { ?>
        <? if ($_SESSION['yjwatsp_user_master_id'] == 1 or $_SESSION['yjwatsp_user_master_id'] == 2) { ?>
          <li <? if ($site_page_name == 'message_credit_list' or $site_page_name == 'message_credit' or $site_page_name == 'approve_payment' or $site_page_name == 'manage_users_list' or $site_page_name == 'manage_users' or $site_page_name == 'user_repository' or $site_page_name == 'view_onboarding') { ?>class="dropdown active" <? } else { ?>class="dropdown" <? } ?>>
