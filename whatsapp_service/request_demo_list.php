...
site_log_generate("Demo Request List Page : User : " . $_SESSION['yjwatsp_user_name'] . " access the page on " . date("Y-m-d H:i:s"));
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Demo Request List :: <?= $site_title ?></title>
...
<body>
	...
	<!-- include sitemenu function adding -->
	  ...
	  <!-- Title and Breadcrumbs -->
          <div class="section-header">
            <h1>Demo Request List</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="dashboard">Dashboard</a></div>
              <div class="breadcrumb-item">Demo Request List</div>
            </div>
          </div>
          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive" id="id_request_demo_list">
                      Loading..
                    </div>
                  </div>
                </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      find_request_demo_list();
    });

    // To list the Users from API
    function find_request_demo_list() {
      $.ajax({
        type: 'post',
        url: "ajax/display_functions.php?call_function=request_demo_list",
        dataType: 'html',
        success: function (response) {
          $("#id_request_demo_list").html(response);
        },
        error: function (response, status, error) { }
      });
    }
    setInterval(find_request_demo_list, 300000); // Every 5 mins (300000), it will call
