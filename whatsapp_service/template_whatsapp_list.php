...
<head>
  ...
  <title>Whatsapp List :: <?= $site_title ?></title>
  ...
  <div id="app">
	...
	<!-- include sitemenu function adding -->
	  ...
	  <!-- Title and Breadcrumbs -->
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item active"><a href="compose_template_whatsapp">Compose Whatsapp</a></div>
	  ...
	  <!-- Compose Whatsapp Button Panel -->
          <div class="row">
            <div class="col-12">
              <h4 class="text-right"><a href="compose_template_whatsapp" class="btn btn-success"><i
