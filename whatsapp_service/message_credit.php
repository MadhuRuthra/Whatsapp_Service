...
if($bar != '') {
  ...
  $usr_vlu = $expld1[0];
  $cnt_vlu = $expld1[1];
  $usrsmscrd_id = $expld1[2];
  // echo "==".$usr_vlu."==".$cnt_vlu."==";
} else {
  // echo "@@".$usr_vlu."@@".$cnt_vlu."@@";
  /* ?>
  <script>window.location = "message_credit_list";</script>
  <?php exit(); */
}
...
<body>
                  ...
                  <form class="needs-validation" novalidate="" id="frm_message_credit" name="frm_message_credit"
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group mb-2 row" style="display: none;">
                        <label class="col-sm-4 col-form-label">Parent User</label>
                        <div class="col-sm-8">
			  <!-- Parent User Panel -->
 ...
 // Looping the indicator is less than the num_of_rows.if the condition is true to continue the process and to get the details.if the condition are false to stop the process
                                ...
                                <option
                                  ...
                                  if ($indicator == 0 or $usr_vlu == $state1->report[$indicator]->user_id) { ?>selected<? } if($usr_vlu != '' and $usr_vlu != $state1->report[$indicator]->user_id) { ?> disabled <? } ?>><?= $state1->report[$indicator]->user_name ?>
                                </option>
                              <?
                              }
                            }
                      ...
                      <div class="form-group mb-2 row">
                        ...
                        <div class="col-sm-8">
                          <input <? if($cnt_vlu != '') { ?> type="hidden" <? } else { ?> type="text" <? } ?> name="txt_message_count" id='txt_message_count' 
                            class="form-control" value="<?= $cnt_vlu ?>" tabindex="3" required maxlength="7"
                            onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"
                            placeholder="Message Count" data-toggle="tooltip" data-placement="top" title=""
                            data-original-title="Message Count"><?=$cnt_vlu?><br>
                    ...
                    <div class="card-footer text-center">
                      ...
                      <input type="hidden" class="form-control" name='hid_usrsmscrd_id' id='hid_usrsmscrd_id' value='<?=$usrsmscrd_id?>' />
