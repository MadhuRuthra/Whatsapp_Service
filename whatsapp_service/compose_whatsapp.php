    ...
    function validate_filesize(file_name) {
      ...
      if (file_name.files[0].name.match(/\.(avi|mp3|mp4|mpeg|ogg)$/i)) {
        ...
        if (parseInt($('#txt_media_duration').val()) > 31) {
          $('#txt_media').val('');
          $("#id_error_display").html("Video File duration must below 10 Mins. Kindly try again!!");
        }
      }
...
// func_validate_campaign_name fun
...
// call_remove_duplicate_invalid fun
