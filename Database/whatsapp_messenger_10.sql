...
--
-- Database: `whatsapp_messenger_10`
--

-- --------------------------------------------------------

--
-- Table structure for table `compose_whatsapp_10`
--

CREATE TABLE `compose_whatsapp_10` (
...
--
-- Table structure for table `compose_whatsapp_status_10`
--

CREATE TABLE `compose_whatsapp_status_10` (
...
--
-- Table structure for table `compose_whatsapp_status_tmpl_10`
--

CREATE TABLE `compose_whatsapp_status_tmpl_10` (
  `comwtap_status_id` int NOT NULL,
  `compose_whatsapp_id` int NOT NULL,
  `country_code` int DEFAULT NULL,
  `mobile_no` varchar(13) NOT NULL,
...
--
-- Table structure for table `compose_whatsapp_tmpl_10`
--

CREATE TABLE `compose_whatsapp_tmpl_10` (
  `compose_whatsapp_id` int NOT NULL,
  `user_id` int NOT NULL,
  `store_id` int NOT NULL,
  `whatspp_config_id` int NOT NULL,
...
--
-- Table structure for table `whatsapp_text_10`
--

CREATE TABLE `whatsapp_text_10` (
...
--
-- Table structure for table `whatsapp_text_tmpl_10`
--

CREATE TABLE `whatsapp_text_tmpl_10` (
...
--
-- Indexes for table `compose_whatsapp_10`
--
ALTER TABLE `compose_whatsapp_10`
  ADD PRIMARY KEY (`compose_whatsapp_id`),
  ADD KEY `user_id` (`user_id`,`store_id`,`whatspp_config_id`);

--
-- Indexes for table `compose_whatsapp_status_10`
--
ALTER TABLE `compose_whatsapp_status_10`
  ADD PRIMARY KEY (`comwtap_status_id`),
  ADD KEY `compose_whatsapp_id` (`compose_whatsapp_id`);

--
-- Indexes for table `compose_whatsapp_status_tmpl_10`
--
ALTER TABLE `compose_whatsapp_status_tmpl_10`
  ADD PRIMARY KEY (`comwtap_status_id`),
  ADD KEY `compose_whatsapp_id` (`compose_whatsapp_id`);

--
-- Indexes for table `compose_whatsapp_tmpl_10`
--
ALTER TABLE `compose_whatsapp_tmpl_10`
  ADD PRIMARY KEY (`compose_whatsapp_id`),
  ADD KEY `user_id` (`user_id`,`store_id`,`whatspp_config_id`);

--
-- Indexes for table `whatsapp_text_10`
--
ALTER TABLE `whatsapp_text_10`
  ADD PRIMARY KEY (`whatsapp_text_id`),
  ADD KEY `compose_whatsapp_id` (`compose_whatsapp_id`);

--
-- Indexes for table `whatsapp_text_tmpl_10`
--
ALTER TABLE `whatsapp_text_tmpl_10`
...
--
-- AUTO_INCREMENT for table `compose_whatsapp_10`
--
ALTER TABLE `compose_whatsapp_10`
  MODIFY `compose_whatsapp_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `compose_whatsapp_status_10`
--
ALTER TABLE `compose_whatsapp_status_10`
  MODIFY `comwtap_status_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `compose_whatsapp_status_tmpl_10`
--
ALTER TABLE `compose_whatsapp_status_tmpl_10`
  MODIFY `comwtap_status_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `compose_whatsapp_tmpl_10`
--
ALTER TABLE `compose_whatsapp_tmpl_10`
  MODIFY `compose_whatsapp_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `whatsapp_text_10`
--
ALTER TABLE `whatsapp_text_10`
  MODIFY `whatsapp_text_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `whatsapp_text_tmpl_10`
--
ALTER TABLE `whatsapp_text_tmpl_10`
