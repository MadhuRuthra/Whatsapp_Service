...
--
-- Database: `whatsapp_messenger_7`
--

-- --------------------------------------------------------

--
-- Table structure for table `compose_whatsapp_7`
--

CREATE TABLE `compose_whatsapp_7` (
...
--
-- Table structure for table `compose_whatsapp_status_7`
--

CREATE TABLE `compose_whatsapp_status_7` (
...
--
-- Table structure for table `compose_whatsapp_status_tmpl_7`
--

CREATE TABLE `compose_whatsapp_status_tmpl_7` (
  `comwtap_status_id` int NOT NULL,
  `compose_whatsapp_id` int NOT NULL,
  `country_code` int DEFAULT NULL,
  `mobile_no` varchar(13) NOT NULL,
...
--
-- Table structure for table `compose_whatsapp_tmpl_7`
--

CREATE TABLE `compose_whatsapp_tmpl_7` (
  `compose_whatsapp_id` int NOT NULL,
  `user_id` int NOT NULL,
  `store_id` int NOT NULL,
  `whatspp_config_id` int NOT NULL,
...
--
-- Table structure for table `whatsapp_text_7`
--

CREATE TABLE `whatsapp_text_7` (
...
--
-- Table structure for table `whatsapp_text_tmpl_7`
--

CREATE TABLE `whatsapp_text_tmpl_7` (
...
--
-- Indexes for table `compose_whatsapp_7`
--
ALTER TABLE `compose_whatsapp_7`
  ADD PRIMARY KEY (`compose_whatsapp_id`),
  ADD KEY `user_id` (`user_id`,`store_id`,`whatspp_config_id`);

--
-- Indexes for table `compose_whatsapp_status_7`
--
ALTER TABLE `compose_whatsapp_status_7`
  ADD PRIMARY KEY (`comwtap_status_id`),
  ADD KEY `compose_whatsapp_id` (`compose_whatsapp_id`);

--
-- Indexes for table `compose_whatsapp_status_tmpl_7`
--
ALTER TABLE `compose_whatsapp_status_tmpl_7`
  ADD PRIMARY KEY (`comwtap_status_id`),
  ADD KEY `compose_whatsapp_id` (`compose_whatsapp_id`);

--
-- Indexes for table `compose_whatsapp_tmpl_7`
--
ALTER TABLE `compose_whatsapp_tmpl_7`
  ADD PRIMARY KEY (`compose_whatsapp_id`),
  ADD KEY `user_id` (`user_id`,`store_id`,`whatspp_config_id`);

--
-- Indexes for table `whatsapp_text_7`
--
ALTER TABLE `whatsapp_text_7`
  ADD PRIMARY KEY (`whatsapp_text_id`),
  ADD KEY `compose_whatsapp_id` (`compose_whatsapp_id`);

--
-- Indexes for table `whatsapp_text_tmpl_7`
--
ALTER TABLE `whatsapp_text_tmpl_7`
...
--
-- AUTO_INCREMENT for table `compose_whatsapp_7`
--
ALTER TABLE `compose_whatsapp_7`
  MODIFY `compose_whatsapp_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `compose_whatsapp_status_7`
--
ALTER TABLE `compose_whatsapp_status_7`
  MODIFY `comwtap_status_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `compose_whatsapp_status_tmpl_7`
--
ALTER TABLE `compose_whatsapp_status_tmpl_7`
  MODIFY `comwtap_status_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `compose_whatsapp_tmpl_7`
--
ALTER TABLE `compose_whatsapp_tmpl_7`
  MODIFY `compose_whatsapp_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `whatsapp_text_7`
--
ALTER TABLE `whatsapp_text_7`
  MODIFY `whatsapp_text_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `whatsapp_text_tmpl_7`
--
ALTER TABLE `whatsapp_text_tmpl_7`
